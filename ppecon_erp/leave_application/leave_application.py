...
#     """
#     Validate file_name and file_data before touching the database.
...
#     # Check base64 is valid and file size within limit
#     try:
...
#     """
#     Decode base64 file and attach it to the given document.
#     Returns the Frappe file URL  (e.g.  /files/certificate.pdf)
#     """
...
#         dt          = doctype,
#         dn          = docname,
#         is_private  = 0,      # 0 = public (visible in attachment tab)
#                               # 1 = private (only logged-in users)
#     )
...
def submit_leave_from_mobile(**kwargs):
    ...
    # validate_leave_access() call hota hai jo check karta hai ki current user
    # ko is employee ka leave dekhne ka haq hai ya nahi.
    # Mobile API mein employee khud apna leave apply kar raha hai — isliye
    # ye permission check bypass karna zaroori hai.
    ...
    frappe.flags.ignore_permissions = False   # reset — baaki system pe asar na pade
